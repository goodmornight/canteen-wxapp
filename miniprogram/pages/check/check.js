...
Page({
          ...
          if (userInfo.rank < 3) {
            ...
            if (isOriginalPwd) {
              Dialog.confirm({
                ...
                //     }
                //   }).then(res_classB => {
                //     console.log(res_classB);

                //     that.setData({
                //       picker_show:true
                //     })
                //     if (res_classB.result.length > 1) {
                //     // 如果该项目下不止一个组织
                //     let classBs = res_classB.result;
                //     let classAName_0 = classBs[0].classAName;
                //     console.log(classBs);
                //     let tempArr = new Array();
                //     for(var i =0;i<classBs.length;i++){
                //       tempArr.push(classBs[i].name)
                //     }
                //     let cols = {};
                //     cols[classAName_0] = tempArr;
                //     that.setData({
                //       tempCols:cols,
                //       classCols:[{
  ...
  changePwdFormSubmit: async function (e) {
    ...
    console.log('changePwdFormSubmit')
    if (newPwd != '' && againPwd != '') {
      if (newPwd == againPwd) {
        //加载动画
        Toast.loading({
